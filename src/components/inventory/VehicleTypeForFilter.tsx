...
const VehicleTypeForFilter: React.FC = () => {
  // All Makes
  const AllVehicleTye: IQuery[] = [
    ...
    >
      ...
      <div className="py-3 px-2  ">
        ...
        <div>
          ...
          >
            {AllVehicleTye.map((vehicleType: IQuery) => (
              <div
...
export default VehicleTypeForFilter;
