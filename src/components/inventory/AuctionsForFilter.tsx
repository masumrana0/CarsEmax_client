...
const AuctionsForFilter: React.FC = () => {
  // All Makes
  const queries: IQuery[] = [
    { name: "Insurance", total: "1,921" },
    { name: "Rental", total: "11,20887" },
    { name: "Repo", total: "11,20887" },
  ];
  ...
  return (
    <div
      className={`border-y border-blue-200 text-sm lg:text-md  transition-all duration-500 ease-in overflow-hidden mt-8 ${
...
export default AuctionsForFilter;
