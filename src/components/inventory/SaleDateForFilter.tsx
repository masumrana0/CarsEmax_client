...
const SaleDateForFilter: React.FC = () => {
  // All queries
  const queries: IQuery[] = [
    { name: "Alabama", total: "1,921" },
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          {/* If user selected any checkbox then reset visible. It Handles Resetting */}
        ...
        <div className="mt-1">
          ...
          {!isShowAllState && (
            <div>
              ...
              >
                <IoMdArrowDropdown /> Show all Sale dates
              </button>
            </div>
          )}
        </div>
...
export default SaleDateForFilter;
