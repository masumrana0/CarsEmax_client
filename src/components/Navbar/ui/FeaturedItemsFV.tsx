...
const FeaturedItemsFV = () => {
  return (
    <div className="md:w-[450px] w-full h-full  flex flex-col flex-wrap gap-2  px-3 py-2 space-y-1   md:px-0 md:py-0">
      <a
        href="#"
...
export default FeaturedItemsFV;
